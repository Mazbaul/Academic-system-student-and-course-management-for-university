    ...
    <section class="sidebar">
      ...
      <!-- <form action="#" method="get" class="sidebar-form">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::path() == 'admin/departments/create' ? "active" : "" }}"><a href="{{route('departments.create')}}"><i class="fa fa-calendar-plus-o"></i><span>Add Department</span></a></li>
            <li class="{{ Request::path() == 'admin/users/create' ? "active" : "" }}"><a href="{{route('users.create')}}"><i class="fa fa-calendar-plus-o"></i><span>Add Student</span></a></li>
            <li class="{{ Request::path() == 'admin/courses' ? "active" : "" }}"><a href="{{route('courses.index')}}"><i class="fa fa-calendar-plus-o"></i><span>Add Course</span></a></li>
            <li class="{{ Request::path() == 'admin/registered' ? "active" : "" }}"><a href="{{ url('/admin/registered') }}"><i class="fa fa-bell"></i><span>Registered Regular </span><span class="{{ !(App\Registered::where('status', '=' ,'0')->count())? "" : "label label-danger"}}">{{ !(App\Registered::where('status', '=' ,'0')->count())? "" : (App\Registered::where('status', '=' ,'0')->count())}}</span></a></li>
            <li class="{{ Request::path() == 'admin/registered/backlog' ? "active" : "" }}"><a href="{{ url('/admin/registered/backlog') }}"><i class="fa fa-bell"></i><span>Registered Backlog </span><span class="{{ !(App\Backlog::where('status', '=' ,'0')->count())? "" : "label label-danger"}}">{{ !(App\Backlog::where('status', '=' ,'0')->count())? "" : (App\Backlog::where('status', '=' ,'0')->count())}}</span></a></li>
