    ...
    <section class="sidebar">
      ...
      <!--  <form action="#" method="get" class="sidebar-form">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::path() == 'admin/registered/backlog' ? "active" : "" }}"><a href="{{ url('/admin/registered/backlog') }}"><span>Registered Students Backlog </span><span class="{{ !(App\Backlog::where('status', '=' ,'0')->count())? "" : "label label-warning"}}">{{ !(App\Backlog::where('status', '=' ,'0')->count())? "" : (App\Backlog::where('status', '=' ,'0')->count())}}</span></a></li>
